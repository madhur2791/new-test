...
<div class="terms-container">
    ...
    <h4>Introduction</h4>
    <p>SoundWavePic (we” or “us”) values its visitors’ privacy. This privacy policy is effective 22 November 2018; it summarizes what information we might collect from a registered user or other visitor (“you”), and what we will and will not do with it.</p>
    <p>Please note that this privacy policy does not govern the collection and use of information by companies that SoundWavePic does not control, nor by individuals not employed or managed by SoundWavePic. If you visit a Web site that we mention or link to, be sure to review its privacy policy before providing the site with information.</p>
    <p>What we do with your personally identifiable information</p>
    <span>It is always up to you whether to disclose personally identifiable information to us, although if you elect not to do so, we reserve the right not to register you as a user or provide you with any products or services. “Personally, identifiable information” means information that can be used to identify you as an individual, such as, for example:</span>
    <ul>
        <li>your name, company, email address, phone number, billing address, and shipping address</li>
        <li>your SoundWavePic user ID and password</li>
        ...
        <li>If you do provide personally identifiable information to us, either directly or through a reseller or other business partner, we will:</li>
        ...
        <li>
            <ul>
                ...
                <li>as necessary to protect the rights, safety, or property of SoundWavePic, its users, or others; this may include (for example) exchanging information with other organizations for fraud protection and/or risk reduction.</li>
            </ul>
        </li>
    </ul>
    ...
    <p>SoundWavePic‘s operations are located primarily in the United States. If you provide information to us, the information will be transferred out of the European Union (EU) to the United States. By providing personal information to us, you are consenting to its storage and use as described herein.</p>
    <h4>Information collected from children</h4>
    <p>You must be at least 13 years old to use SoundWavePic‘s Web site(s) and service(s). SoundWavePic does not knowingly collect information from children under 13. (See the U.S. Children’s Online Privacy Protection Act.)</p>
    ...
    <p>If you have questions or comments about SoundWavePic's privacy policy, send an email to <a href="mailto:hello@soundwavepic.com">hello@soundwavepic.com</a>, or contact us via any of the ways described in the About Us page at URL of <a href="www.soundwavepic.com">www.SoundWavePic.com</a>.</p>
    <p>Thank you for choosing SoundWavePic!</p>
</div>
