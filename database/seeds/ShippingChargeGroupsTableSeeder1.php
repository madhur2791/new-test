...
class ShippingChargeGroupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('shipping_charge_groups')->insert([
            ...
            ['shipping_charge_group_id'=> 1, 'pricing_list_id' => '9', 'shipping_charge' => 0, 'created_at' => NOW(), 'updated_at' => NOW()],
            ...
            ['shipping_charge_group_id'=> 2, 'pricing_list_id' => '9', 'shipping_charge' => 50, 'created_at' => NOW(), 'updated_at' => NOW()],
